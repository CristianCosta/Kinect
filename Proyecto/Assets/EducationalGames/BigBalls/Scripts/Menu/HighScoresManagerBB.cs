...
public class HighScoresManagerBB : MonoBehaviour {
	...
	void Awake(){
		...
		this.players= GameLogManager.getInstance().getHighScores("top5bigballs");
		
		Debug.Log(((HighScoreData)this.players[1]).getName()); 
